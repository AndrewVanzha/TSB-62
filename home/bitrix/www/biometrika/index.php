...
$APPLICATION->SetPageProperty("keywords", "биометрическая система, биометрические данные");
$APPLICATION->SetPageProperty("title", "Единая биометрическая система | АКБ «ТрансСтройБанк»");
...
<?$APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "IBLOCK_ID" => "216",	// Инфоблок Обслуживание счетов физлиц
