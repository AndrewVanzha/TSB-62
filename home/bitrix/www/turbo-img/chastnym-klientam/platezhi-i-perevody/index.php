...
$APPLICATION->SetPageProperty("title", "Payments and Remittances |  Personal | Transstroibank");

?><?$APPLICATION->IncludeComponent(
	"bitrix:news",
	"en_payments_transfers",
	Array(
		"ADD_ELEMENT_CHAIN" => "Y",
		...
		"CACHE_TYPE" => "A",
		"CHECK_DATES" => "Y",
		"COMPONENT_TEMPLATE" => "payments_transfers",
		...
		"DETAIL_PROPERTY_CODE" => array(0=>"ADD_INFO_BANK",1=>"ADD_INFO_SELF",2=>"",),
		...
		"LIST_PROPERTY_CODE" => array(0=>"ADD_INFO_BANK",1=>"ADD_INFO_SELF",2=>"ATT_URL",3=>"ATT_PRICE",4=>"",),
		"MESSAGE_404" => "",
		"META_DESCRIPTION" => "-",
		"META_KEYWORDS" => "-",
		"NEWS_COUNT" => "20",
		...
		"SEF_FOLDER" => "/en/chastnym-klientam/platezhi-i-perevody/",
		"SEF_MODE" => "Y",
