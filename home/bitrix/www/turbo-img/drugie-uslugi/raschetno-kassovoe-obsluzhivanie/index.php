...
$APPLICATION->SetPageProperty("description", "Расчетно-кассовое обслуживание в АКБ «ТрансСтройБанк» позволит Вам в полном объеме воспользоваться всеми преимуществами безналичных расчетов");
$APPLICATION->SetPageProperty("keywords", "Расчетно-кассовое обслуживание АКБ «ТрансСтройБанк»");
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_PROPERTY_CODE" => array("ADD_INFO_BANK","ADD_INFO_SELF","MAX_SUM","MAX_DATE","INTEREST_RATE",""),
		...
		"LIST_PROPERTY_CODE" => array("ADD_INFO_BANK","ADD_INFO_SELF","MAX_SUM","MAX_DATE","INTEREST_RATE",""),
		"MESSAGE_404" => "",
		"META_DESCRIPTION" => "-",
		"META_KEYWORDS" => "-",
		"NEWS_COUNT" => "20",
		...
		"SEF_FOLDER" => "/en/chastnym-klientam/drugie-uslugi/raschetno-kassovoe-obsluzhivanie/",
		"SEF_MODE" => "Y",
