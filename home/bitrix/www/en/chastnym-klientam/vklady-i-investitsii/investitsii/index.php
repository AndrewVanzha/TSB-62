...
$APPLICATION->SetPageProperty("description", "Quotes of bullion, precious metals in the Bank 'Transstroibank'");
$APPLICATION->SetPageProperty("keywords", "Quotes, Gold, bullion, precious, metal, GOLD.");
$APPLICATION->SetPageProperty("title", "Investments | Personal | Transstroibank");
$APPLICATION->SetTitle("Investments");
?>
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"SEF_FOLDER" => "/en/chastnym-klientam/vklady-i-investitsii/investitsii/",
		"SEF_MODE" => "Y",
		"SET_LAST_MODIFIED" => "N",
		"SET_STATUS_404" => "Y",
		"SET_TITLE" => "Y",
