...
$APPLICATION->SetPageProperty("description", "АКБ «Трансстройбанк» (АО) предлагает своим клиентам оформить ипотечные кредиты на выгодных условиях. Среди многообразия продуктов и специальных программ, каждый потенциальный заемщик сможет найти именно то, что ему необходимо");
$APPLICATION->SetPageProperty("keywords", "Ипотечное кредитование");
$APPLICATION->SetPageProperty("title", "Ипотечное кредитование | Ипотека и кредиты | ЧАСТНЫМ ЛИЦАМ | Трансстройбанк");
...
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"CACHE_TYPE" => "A",
		"CHECK_DATES" => "Y",
		"COMPONENT_TEMPLATE" => "kredit-ipoteka",
		...
		"DETAIL_PROPERTY_CODE" => array(0=>"ADD_INFO_BANK",1=>"ADD_INFO_SELF",2=>"MAX_SUM",3=>"MAX_DATE",4=>"INTEREST_RATE",5=>"",),
		...
		"LIST_PROPERTY_CODE" => array(0=>"ADD_INFO_BANK",1=>"ADD_INFO_SELF",2=>"MAX_SUM",3=>"MAX_DATE",4=>"INTEREST_RATE",5=>"",),
		"MESSAGE_404" => "",
		"META_DESCRIPTION" => "-",
		"META_KEYWORDS" => "-",
		"NEWS_COUNT" => "20",
		...
		"SEF_FOLDER" => "/en/chastnym-klientam/kredity/ipoteka/",
		"SEF_MODE" => "Y",
