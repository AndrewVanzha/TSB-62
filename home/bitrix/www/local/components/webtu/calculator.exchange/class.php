...
class CalculatorExchange extends CBitrixComponent
{
    ...
    protected function getOffice()
    {
        ...
        while($arElement = $rsElements->Fetch()){
            ...
            foreach ($arElement["PROPERTY_ATT_CODE_VALUE"] as $code) {
                ...
                $rsOffices = CIBlockElement::GetList(
                    ...
                    false,
                    //Array()
                    Array("IBLOCK_ID","PROPERTY_EN_OFFICE_NAME", "ID", "NAME", "PROPERTY_ATT_ADDRESS", "PROPERTY_ATT_PHONE", "PROPERTY_ATT_PHONE_LINK", "PROPERTY_ATT_OFFICE_HOURS", "PROPERTY_ATT_YANDEX_LOCATION", "PROPERTY_ATT_YANDEX_POS", "PROPERTY_ATT_2GIS_LOCATION")
                );
        ...
        $rsOnlineOffice = CIBlockElement::GetList(
            Array("SORT"=>"ASC"),
            Array("IBLOCK_ID"=>$this->arParams['OFFICE_IBLOCK_ID'], "PROPERTY_ATT_CODE"=>10900, "ACTIVE"=>"Y"), // iSimple
            false,
            false,
            Array("IBLOCK_ID", "PROPERTY_EN_OFFICE_NAME","ID", "NAME", "PROPERTY_ATT_ADDRESS", "PROPERTY_ATT_PHONE", "PROPERTY_ATT_PHONE_LINK", "PROPERTY_ATT_OFFICE_HOURS", "PROPERTY_ATT_YANDEX_LOCATION", "PROPERTY_ATT_YANDEX_POS", "PROPERTY_ATT_2GIS_LOCATION")
        );
