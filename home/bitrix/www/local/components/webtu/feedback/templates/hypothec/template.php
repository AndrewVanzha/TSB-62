...
<form action="<?=$_SERVER['REQUEST_URI']?>" method="POST">
    ...
    <div class="popup-form_content">
		...
		<? 
			...
			$politics_1 = "<a href='/assets/docs/Правила оформления онлайн заявок.pdf' target='_blank'>" .GetMessage("WEBTU_FEEDBACK_8_POLITICS_1"). "</a>";
			$politics_2 = "<a href='/assets/docs/Согласие на обработку ПД для сайта.pdf' target='_blank'>" .GetMessage("WEBTU_FEEDBACK_8_POLITICS_2"). "</a>";
