...
function sanitizePost(array $data): array
{
    ...
    /*if (!empty($data['NAME'])) {
        $data['NAME'] = $data['NAME']; // . ' ' . $data['FIRST_NAME'] . ' ' . $data['SECOND_NAME'];
    }*/
    return $data;
}
...
//debugg($fields);
//file_put_contents($_SERVER['DOCUMENT_ROOT'] . '/corporative-clients/bankovskoe-obsluzhivanie/vneshneekonomicheskaya-deyatelnost/ajax_customer_fields.txt', $fields);
...
//file_put_contents($_SERVER['DOCUMENT_ROOT'] . '/corporative-clients/bankovskoe-obsluzhivanie/vneshneekonomicheskaya-deyatelnost/ajax_customer_properties.txt', $properties);
...
$elementFields['NAME']         = isset($fields['COMPANY'])      ? $fields['COMPANY']      : 'Новое обращение';
$elementFields['COMPANY']      = isset($fields['COMPANY'])      ? $fields['COMPANY']      : '';
$elementFields['FIO']          = isset($fields['FIO'])          ? $fields['FIO']          : '';
...
finish($arResult);
/*
c584663bb22304b8edb00f72003eece0
{"IBLOCK_ID":"206",
"PROPERTIES":["COMPANY","PHONE","EMAIL","CITY","FIO"],
...
andreww1000@mail.ru
Москва
0de92a5b041a2a1094081e2869db76aaJW5CN*/
