                    ...
                    <div class="card-application--form__section">
                        <div class="grid__item-1">
                            <label class="input-group">
                                ...
                                <?/*?>
                                <input type="text" name="COMPANY_NAME" placeholder="организация" class="input-group__field" required
    ...
    $(document).ready(function() {
        ...
        function changeColors(scrollTop) {
            ...
            /*if(scrollTop > (fixLevel2+200)) {
                $('.ved-page__background-blue').css('position', 'unset'); // для нижний блоков отработать стилем z-index
            } else if(scrollTop > (fixLevel1-200)) {
                $('.ved-page__background-blue').css('position', 'fixed');
            } else {
                $('.ved-page__background-blue').css('position', 'unset');
            }*/
    ...
    $('#applicationForm').submit(function (e) {
        ...
        if ($("#politics1").prop("checked")) {
            ...
            if (requiredFields()) {
                ...
                $.ajax({
                    type: "POST",
                    //url: '/local/components/webtu/feedback/templates/VED_foreign_currency_account_new/ajax.customer.php',
