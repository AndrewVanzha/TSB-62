...
<div id="popup-buy-2" class="popup">
    ...
    ?>
        <form class="form-subs" action="<?=$APPLICATION->GetCurPageParam("", array("MESSAGE_SEND_".$arResult["COMPONENT_ID"], "MESSAGE_ERROR_".$arResult["COMPONENT_ID"]))?>" method="post" enctype="multipart/form-data">
            <div class="title-wrap">
        		<div class="title-form">Оставьте номер, мы Вам перезвоним</div>
        	...
        	<div class="group">
                <input class="submit" name="FBKA_SUBMIT" type="submit" value="Оформить заказ" onclick="ga('send','event','byOneClick','clicked');yaCounter44820226.reachGoal('byOneClick');" />
        	</div>
        </form>
    <?}?>
