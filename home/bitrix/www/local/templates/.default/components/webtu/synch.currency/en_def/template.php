...
<div class="exchange-course" style="background-image: url(/local/templates/.default/img/exchange-course.jpg);">
    ...
    <div class="page-container clearfix">
        ...
        <div class="exchange-course_brief">
			...
			<a href="/en/chastnym-klientam/konvertor-valyut/" class="button">
...
Dear Customer! Please note that the currency exchange rates in each individual branch may vary from ones specified on the website. Please go to <a href = "/en/chastnym-klientam/konvertor-valyut/
">Exchange Operations</a> to get the accurate information
