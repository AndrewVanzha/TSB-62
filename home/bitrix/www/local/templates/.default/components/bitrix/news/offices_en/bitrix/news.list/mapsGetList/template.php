...
if (in_array('office', $_REQUEST['type'])||(empty($_REQUEST['type']))) 
    $typeFilter[] = array("=PROPERTY_ATT_TYPE_VALUE"=>"Офис");
if (in_array('cash', $_REQUEST['type'])) 
    $typeFilter[] = array("=PROPERTY_ATT_TYPE_VALUE"=>"Банкомат");
if (in_array('partners', $_REQUEST['type'])) 
        ...
        <form class="filter" action="" method="post">
            ...
            <div class="city select-box">
                ...
                <select id="city" data-id="<?=htmlspecialchars($_REQUEST['city'])?>" name="city">
                    ...
                    <?foreach ($arSections as $section){?>
                        ...
                        <option  value="<?=$section['ID']?>" <?if (htmlspecialchars($_REQUEST['city']) == $section['ID']){?>selected<?}?>>
            ...
            <div class="view">
                ...
                <div class="switch-box clearfix">
                    ...
                    <a id='maps' onclick="maps();" href="javascript:void(0);" class="switch-box_caption <?if(htmlspecialchars($_REQUEST['maps'] != 'no')){?>is-active<?}?>">
                    ...
                    <a id='switch' href="#" class="switch-box_lever <?if(htmlspecialchars($_REQUEST['maps'] == 'no')){?>is-active-right<?}else{?>is-active-left<?}?>"></a>

                    <a id='list' onclick="list();" href="javascript:void(0);" class="switch-box_caption <?if(htmlspecialchars($_REQUEST['maps'] == 'no')){?>is-active<?}?>">
            ...
            <div class="type clearfix" onclick="$('#send').click();">

                <label class="check-box">
                    <input type="checkbox" name="type[]" value="office" <?if (in_array('office', $_REQUEST['type'])||(empty($_REQUEST['type']))) {?>checked<?}?>>
                ...
                <label class="check-box">
                    <input type="checkbox" name="type[]" value="cash" <?if (in_array('cash', $_REQUEST['type'])){?>checked<?}?>>
                    <span class="check-box_caption">
                        Банкоматы
                    </span>
                </label>

                <label class="check-box" onclick="getList();">
                    <input type="checkbox" name="type[]" value="partners" <?if (in_array('partners', $_REQUEST['type'])){?>checked<?}?>>
                    <span class="check-box_caption">
                        Банкоматы партнеров
                    </span>
                </label>
