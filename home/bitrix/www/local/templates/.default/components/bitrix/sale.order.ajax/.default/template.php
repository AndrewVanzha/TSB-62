...
$arParams["MESS_PAY_PODRONEE_O_DOSTAVKE"] = Loc::getMessage('PAY_PODRONEE_O_DOSTAVKE');
$arParams["MESS_PAY_LINK_PODRONEE_O_DOSTAVKE"] = "/dostavka-i-oplata/";
$arParams["MESS_PAY_GARANTII_I_VOXVRAT"] = Loc::getMessage('PAY_GARANTII_I_VOXVRAT');
$arParams["MESS_PAY_LINK_GARANTII_I_VOXVRAT"] = "/personal/2/";
$arParams["MESS_PAY_PODRONEE_OB_OPLATE"] = Loc::getMessage('PAY_PODRONEE_OB_OPLATE');
$arParams["MESS_PAY_LINK_PODRONEE_OB_OPLATE"] = "/dostavka-i-oplata/";
		...
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			...
			<div class="col-sm-9 bx-soa">
				...
				<div id="bx-soa-orderSave" class="hidden-xs">
					<a href="javascript:void(0)" style="margin: 10px 0" class="pull-left btn btn-default btn-lg" onclick="ga('send','event','buyEnd','clicked');yaCounter44820226.reachGoal('buyEnd');">
						<?=$arParams['MESS_ORDER']?>
					</a>
				</div>
