...
<section class="page-section">
    <div class="product-items deposits clearfix">
        	...
        	<div class="product-item--short product-item">
                ...
                <div class="heading">
                    ...
                    <div class="aligner">
                        ...
                        <p class="income">
                            up to <?=$arItem['PROPERTIES']['RUB_INTEREST_RATE']['VALUE']?>% annually
                        </p>
        		...
        		<div class="bg" style="background-image: url(<?=$arItem['PREVIEW_PICTURE']['SRC']?>);">
        			<div class="content">
        				<div class="brief" style="height:220px;">
                            <p>
                                Minimum amount:
                                <br>
                                <span>
                                    <?=number_format($arItem['PROPERTIES']['RUB_MIN_SUMM']['VALUE'], 0, ',', ' ');?> RUB
                                </span>
                            </p>
                            
                            <? if (!empty($arItem['PROPERTIES']['ADVANTAGES']['VALUE'])) { ?>
                                <p>
                                    Advantages:
                                    <br>
                                    <span>
