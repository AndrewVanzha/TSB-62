...
$MESS["PAY_PODRONEE_O_DOSTAVKE"] = "Подробнее о доставке";
$MESS["PAY_GARANTII_I_VOXVRAT"] = "Гарантии и возврат товара";
$MESS["PAY_PODRONEE_OB_OPLATE"] = "Подробнее об оплате";

$MESS["SOA_ORDER_OBRATITE_VASHE_VNIMANIE"] = "Обратите внимание что оплата заказа будет доступна после подтверждения ваших паспортных данных в личном кабинете.";
?>
