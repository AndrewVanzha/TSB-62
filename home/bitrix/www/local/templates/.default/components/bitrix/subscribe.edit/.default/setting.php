...
<tr valign="top">
	<td width="40%">
		...
		<?foreach($arResult["RUBRICS"] as $itemID => $itemValue):?>
			<label>
				<input type="checkbox" name="RUB_ID[]" value="<?=$itemValue["ID"]?>"<?if($itemValue["CHECKED"]) echo " checked"?> /><strong><?=$itemValue["NAME"]?></strong>
				<p style="margin:5px 20px;"><?=$itemValue["DESCRIPTION"]?></p>
			</label>
		<?endforeach;?>
		<br>
