...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"PARENT_SECTION" => 568,
		//"CREDIT_CARD_PARAMS" => [759, 760, 761, 762, 763, 764],
		"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
		"IBLOCK_ID" => $arParams["IBLOCK_ID"],
		...
		<div class="v21-container">
			<?$APPLICATION->IncludeComponent(
				...
				Array(
					...
					//"PROPERTIES" => array("PHONE","CREDIT_SUMM","LATIN","NAME","EMAIL","ORGANIZATION","CITY"),
					"SITES" => array(0=>"s1",),
					//"USER_EVENT" => "WEBTU_FEEDBACK_TARIFSS_FL_USER",
                    "UTM" => "147", // Согласие на новые тарифы: администратор
				)
			);?>
		</div>
	</div>
