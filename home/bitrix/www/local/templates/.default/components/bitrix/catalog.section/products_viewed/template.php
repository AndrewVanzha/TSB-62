...
if (!empty($arResult['ITEMS'])){ ?>
    <div class="content-block-2">
        <div class="content-header">
            <div class="heading aligner">Вы смотрели</div>
            <div class="number aligner">( <?=count($arResult['ITEMS'])?> )</div>
        </div>
        <div class="carousel-wrap" style="padding-top: 6px;">
                            ...
                            <div class="info">
                                ...
                                <? if ($arItem["IBLOCK_SECTION_ID"] == 18) { ?>
                                    <div class="mobile-btn">
                                        <div class="info-hover-text">
                                            Размен возможен в <a href="https://coins.tsbnk.ru/dostavka-i-oplata/">офисах банка</a>
                                        </div>
                                    </div>
                                <? } elseif ($price > 0) { ?>
