...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
		...
		insertFileProperty: function(property, propsItemNode, disabled)
		{
			...
			propsItemNode.innerHTML += '<br>Если Вы хотите приобрести монеты с доставкой, Вам необходимо прикрепить скан паспорта с разворотом главной страницы и страницы с пропиской. Действующее законодательство требует проводить все операции с драгоценными металлами по предъявлению паспорта. При доставке Вашего заказа ФГУП Спецсвязь попросит Вас предъявить паспорт.';
		...
		editTotalBlock: function()
		{
            ...
            this.totalInfoBlockNode.appendChild(
    			BX.create('DIV', {
    				props: {className: 'links-result'},
    				children: [
    					BX.create('A', {
    						props: {
    						  href: this.params.MESS_PAY_LINK_PODRONEE_O_DOSTAVKE,
                              className: 'item-1 icon-2'
    						},
    						html: this.params.MESS_PAY_PODRONEE_O_DOSTAVKE,
    						events: {}
    					}),
    					/*
                        BX.create('A', {
    						props: {
    						  href: this.params.MESS_PAY_LINK_GARANTII_I_VOXVRAT,
                              className: 'item-2 icon-2'
    						},
    						html: this.params.MESS_PAY_GARANTII_I_VOXVRAT,
    						events: {}
    					}),
                        */
    					BX.create('A', {
    						props: {
    						  href: this.params.MESS_PAY_LINK_PODRONEE_OB_OPLATE,
                              className: 'item-3 icon-2'
    						},
    						html: this.params.MESS_PAY_PODRONEE_OB_OPLATE,
    						events: {}
    					})
    				]
    			})
