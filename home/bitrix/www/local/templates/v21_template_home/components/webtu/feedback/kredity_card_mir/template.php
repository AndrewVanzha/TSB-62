                    ...
                    <div class="card-application--form__section">
                        <div class="grid__item-1">
                            <label class="input-group">
                                ...
                                <?/*?><input type="text" name="ORGANIZATION" placeholder="организация" class="input-group__field" required
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        //$('.v21 .credit_summ .input-group__field').on("change", function () {
        $('.v21 .credit_summ .input-group__field').on("input keyup", function () {
        //$('.v21 .credit_summ .input-group__field').on("click", function () {
            let qNum = parseInt(this.value, 10);
            slider.slider("value", qNum);
            //console.log($('.v21 .credit_summ .input-group__field').val());
        });
        ...
        function changeColors(scrollTop) {
            ...
            /*if(scrollTop > (fixLevel2+200)) {
                $('.mir-page__background-blue').css('position', 'unset'); // для нижний блоков отработать стилем z-index
            } else if(scrollTop > (fixLevel1-200)) {
                $('.mir-page__background-blue').css('position', 'fixed');
            } else {
                $('.mir-page__background-blue').css('position', 'unset');
            }*/
