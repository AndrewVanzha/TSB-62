    ...
    <div class="form-block">
        ...
        <div class="form-block--right">
            <form action="<?=$_SERVER['REQUEST_URI']?>" method="POST" class="card-application--form" id="applicationForm">
                ...
                <input type="hidden" name="RECOURSE" value="">
                <?
    ...
    $(document).ready(function() {
        function changeColors(scrollTop) {
            ...
            /*if(scrollTop > (fixLevel2+200)) {
                $('.sbp-page__background-blue').css('position', 'unset'); // для нижний блоков отработать стилем z-index
            } else if(scrollTop > (fixLevel1-200)) {
                $('.sbp-page__background-blue').css('position', 'fixed');
            } else {
                $('.sbp-page__background-blue').css('position', 'unset');
            }*/
