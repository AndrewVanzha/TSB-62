                                    ...
                                    <? } else { ?>
                                        ...
                                        <td>
                                            <div class="v21-exchange-table__type" style="width: 3.2em; text-align: left;">
                                                ...
                                                <?= ($symb[0] == 'IDR')? '<sup style="font-size: 50%;">7</sup>' : ''; ?>
                                                <?= ($symb[0] == 'ILS')? '<sup style="font-size: 50%;">8</sup>' : ''; ?>
                                                <?= ($symb[0] == 'INR')? '<sup style="font-size: 50%;">9</sup>' : ''; ?>
                                                <?= ($symb[0] == 'JPY')? '<sup style="font-size: 50%;">10</sup>' : ''; ?>
                                                <?= ($symb[0] == 'KGS')? '<sup style="font-size: 50%;">11</sup>' : ''; ?>
                                                <?= ($symb[0] == 'KRW')? '<sup style="font-size: 50%;">12</sup>' : ''; ?>
                                                <?= ($symb[0] == 'KZT')? '<sup style="font-size: 50%;">13</sup>' : ''; ?>
                                                <?= ($symb[0] == 'MDL')? '<sup style="font-size: 50%;">14</sup>' : ''; ?>
                                                <?= ($symb[0] == 'MXN')? '<sup style="font-size: 50%;">15</sup>' : ''; ?>
                                                <?= ($symb[0] == 'QAR')? '<sup style="font-size: 50%;">16</sup>' : ''; ?>
                                                <?= ($symb[0] == 'RSD')? '<sup style="font-size: 50%;">17</sup>' : ''; ?>
                                                <?= ($symb[0] == 'SAR')? '<sup style="font-size: 50%;">18</sup>' : ''; ?>
                                                <?= ($symb[0] == 'THB')? '<sup style="font-size: 50%;">19</sup>' : ''; ?>
                                                <?= ($symb[0] == 'TJS')? '<sup style="font-size: 50%;">20</sup>' : ''; ?>
                                                <?= ($symb[0] == 'TRY')? '<sup style="font-size: 50%;">21</sup>' : ''; ?>
                                                <?= ($symb[0] == 'UZS')? '<sup style="font-size: 50%;">22</sup>' : ''; ?>
                                                <?= ($symb[0] == 'ZAR')? '<sup style="font-size: 50%;">23</sup>' : ''; ?>
                                            </div>
                                        </td>
                                    <? } ?>
                                <? } ?>
                ...
                <div class="v21-exchange-note">
                    ...
                    <p class="v21-exchange-note__item">
                        ...
                        <? if ($arResult['CUR']['IDR'][1] !== '/') { ?>
                            7 - <?= GetMessage("CURS_COUNT_IDR") ?><br>
                            <? //редактировать в lang/ru/template.php и lang/en/template.php 
                            ?>
                        <? } ?>
                        <? if ($arResult['CUR']['ILS'][1] !== '/') { ?>
                            8 - <?= GetMessage("CURS_COUNT_ILS") ?><br>
                            <? //редактировать в lang/ru/template.php и lang/en/template.php 
                            ?>
                        <? } ?>
                        <? if ($arResult['CUR']['INR'][1] !== '/') { ?>
                            9 - <?= GetMessage("CURS_COUNT_INR") ?><br>
                            <? //редактировать в lang/ru/template.php и lang/en/template.php 
                            ?>
                        <? } ?>
                        <? if ($arResult['CUR']['JPY'][1] !== '/') { ?>
                            10 - <?= GetMessage("CURS_COUNT_JPY") ?><br>
                            <? //редактировать в lang/ru/template.php и lang/en/template.php 
                            ?>
                        <? } ?>
                        <? if ($arResult['CUR']['KGS'][1] !== '/') { ?>
                            11 - <?= GetMessage("CURS_COUNT_KGS") ?><br>
                            <? //редактировать в lang/ru/template.php и lang/en/template.php 
                            ?>
                        <? } ?>
                        <? if ($arResult['CUR']['KRW'][1] !== '/') { ?>
                            12 - <?= GetMessage("CURS_COUNT_KRW") ?><br>
                            <? //редактировать в lang/ru/template.php и lang/en/template.php 
                            ?>
                        <? } ?>
                        <? if ($arResult['CUR']['KZT'][1] !== '/') { ?>
                            13 - <?= GetMessage("CURS_COUNT_KZT") ?><br>
                            <? //редактировать в lang/ru/template.php и lang/en/template.php 
                            ?>
                        <? } ?>
                        <? if ($arResult['CUR']['MDL'][1] !== '/') { ?>
                            14 - <?= GetMessage("CURS_COUNT_MDL") ?><br>
                            <? //редактировать в lang/ru/template.php и lang/en/template.php 
                            ?>
                        <? } ?>
                        <? if ($arResult['CUR']['MXN'][1] !== '/') { ?>
                            15 - <?= GetMessage("CURS_COUNT_MXN") ?><br>
                            <? //редактировать в lang/ru/template.php и lang/en/template.php 
                            ?>
                        <? } ?>
                        <? if ($arResult['CUR']['QAR'][1] !== '/') { ?>
                            16 - <?= GetMessage("CURS_COUNT_QAR") ?><br>
                            <? //редактировать в lang/ru/template.php и lang/en/template.php 
                            ?>
                        <? } ?>
                        <? if ($arResult['CUR']['RSD'][1] !== '/') { ?>
                            17 - <?= GetMessage("CURS_COUNT_RSD") ?><br>
                            <? //редактировать в lang/ru/template.php и lang/en/template.php 
                            ?>
                        <? } ?>
                        <? if ($arResult['CUR']['SAR'][1] !== '/') { ?>
                            18 - <?= GetMessage("CURS_COUNT_SAR") ?><br>
                            <? //редактировать в lang/ru/template.php и lang/en/template.php 
                            ?>
                        <? } ?>
                        <? if ($arResult['CUR']['THB'][1] !== '/') { ?>
                            19 - <?= GetMessage("CURS_COUNT_THB") ?><br>
                            <? //редактировать в lang/ru/template.php и lang/en/template.php 
                            ?>
                        <? } ?>
                        <? if ($arResult['CUR']['TJS'][1] !== '/') { ?>
                            20 - <?= GetMessage("CURS_COUNT_TJS") ?><br>
                            <? //редактировать в lang/ru/template.php и lang/en/template.php 
                            ?>
                        <? } ?>
                        <? if ($arResult['CUR']['TRY'][1] !== '/') { ?>
                            21 - <?= GetMessage("CURS_COUNT_TRY") ?><br>
                            <? //редактировать в lang/ru/template.php и lang/en/template.php 
                            ?>
                        <? } ?>
                        <? if ($arResult['CUR']['UZS'][1] !== '/') { ?>
                            22 - <?= GetMessage("CURS_COUNT_UZS") ?><br>
                            <? //редактировать в lang/ru/template.php и lang/en/template.php 
                            ?>
                        <? } ?>
                        <? if ($arResult['CUR']['ZAR'][1] !== '/') { ?>
                            23 - <?= GetMessage("CURS_COUNT_ZAR") ?><br>
                            <? //редактировать в lang/ru/template.php и lang/en/template.php 
                            ?>
                        <? } ?>
                    </p>
