                    ...
                    <div class="card-application--form__section">
                        <div class="grid__item-1">
                            <label class="input-group">
                                ...
                                <?/*?>
                                <input type="text" name="COMPANY_INN" placeholder="организация" class="input-group__field" required
...
<script type="text/javascript">
    $(document).ready(function() {
        $('input[name=NAME]').val($('input[name=ORGANIZATION]').val()); // пишу в input[name=NAME] исходное значение из input[name=ORGANIZATION]
