...
//file_put_contents($_SERVER['DOCUMENT_ROOT'] . '/currency/a_menu_$arResult.json', json_encode($arResult));
$ii = 0;
foreach($arResult as $key=>$arItem)
{
	...
	{
        //debugg($arItem);
        //debugg('params-item_id');
        //debugg($arItem["PARAMS"]["item_id"]);
...
//debugg($arAllItems);
//file_put_contents($_SERVER['DOCUMENT_ROOT'] . '/currency/a_menu_$arAllItems.json', json_encode($arAllItems));
