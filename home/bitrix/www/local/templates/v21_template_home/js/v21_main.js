    ...
    document.querySelectorAll('.js-v21-dropdown-toggle').forEach(function (toggle) {
      ...
      toggle.addEventListener('click', function (e) {
        ...
        if (toggle.dataset.scrollAnchor) {
          //console.log(document.querySelector('.v21-header-2'));
...
function exchangeCalcInit(element, data) {
  ...
  swap.addEventListener('click', function () {
    ...
    let curr_text = document.querySelectorAll('.choices__list--single_html');
    [].forEach.call(curr_text, (elem) => { elem.remove(); });
  });
