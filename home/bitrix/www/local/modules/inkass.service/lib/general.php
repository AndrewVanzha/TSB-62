...
class General
{
    ...
    private static $questions_list = [  //  максимум = 10, иначе расширять БД
        ...
        1 => '2. Сохранность ДС в установленном порядке:<br>- денежный ящик<br>- сейф',
        2 => '3. Порядок снятия / постановки на ОПС',
        3 => '4. Хранение личных вещей и ДС в отдельном шкафу',
        4 => '5. Закрытие кассы на все установленные замки',
        //6 => '7. Исправность системы внутреннего видеонаблюдения и ее использование кассиром',
        5 => '6. Соблюдение порядка запуска инкассаторов в помещение кассового узла.',
    ];
