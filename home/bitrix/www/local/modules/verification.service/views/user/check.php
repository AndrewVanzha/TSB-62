...
<div class="vs-order__wrapper">
    ...
    <div class="vs-order__block">
        ...
        <div class="vs-order__table">
            ...
            <? if ($order['status_captcha'] != 1 && $order['status_phone'] != 1): ?>
                <form action="/local/modules/verification.service/process/user.php" method="post">
                    <div class="vs-order__tr">
                        <div class="vs-order__th">Код с картинки</div>
                        <div class="vs-order__td">

                            <div class="vs-order__flex">
                    ...
                    <button class="vs-button vs-order__button" style="margin-bottom: 5px;">Подтвердить</button>
                </form>
            <? endif; ?>
            ...
            <? endif; ?>
            <? if ($order['status_phone'] != 1 && $order['status_captcha'] == 1): ?>
                <div class="vs-order__tr">
                    <div class="vs-order__th">Код из СМС</div>
                    <div class="vs-order__td">
                        <form action="/local/modules/verification.service/process/user.php" method="post"
