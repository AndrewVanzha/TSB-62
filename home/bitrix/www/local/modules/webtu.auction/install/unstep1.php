...
<?=bitrix_sessid_post()?>
	...
	<input type="hidden" name="id" value="webtu.auction" />
	...
	<p><input type="checkbox" name="savedata" id="savedata" value="Y" checked="checked" /><label for="savedata"><?echo Loc::getMessage("MOD_UNINST_SAVE_TABLES")?></label></p>
