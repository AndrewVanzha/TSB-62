...
<h1 class="v21-h1-new v21-safes-page--header">Аренда сейфов в банке для бизнеса</h1>
...
<div class="v21-section">
	<h2 class="v21-h2-new v21-safes-page--subheader">Стоимость аренды банковских ячеек</h2>
	<? $APPLICATION->IncludeComponent(
		"bitrix:news.list",
		"v21_safes",
		array(
