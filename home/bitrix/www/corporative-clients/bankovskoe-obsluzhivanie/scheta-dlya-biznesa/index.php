            ...
            <div class="v21-container">
                <?$APPLICATION->IncludeComponent(
                    ...
                    Array(
                        ...
                        "PROPERTIES" => array("PHONE","COMPANY_NAME","ORGANIZATION","COMPANY_INN","FIO","NAME","EMAIL","CITY","FOLDER","REQ_URI","FROM_WHERE","UTM_SOURCE","UTM_MEDIUM","UTM_CAMPAIGN","UTM_TERM","UTM_CONTENT"),
            ...
            <div class="eq-docs__list">
                <?$APPLICATION->IncludeComponent(
                    ...
                    Array(
                        ...
                        "DISPLAY_TOP_PAGER" => "N",
                        "ELEMENT_CODE" => "",
                        "ELEMENT_ID" => "8887", // Документы 9111 ?
                        "FIELD_CODE" => array("", ""),
                        "IBLOCK_ID" => "189",
                        "IBLOCK_TYPE" => "ls_documents",
                        "IBLOCK_URL" => "",
