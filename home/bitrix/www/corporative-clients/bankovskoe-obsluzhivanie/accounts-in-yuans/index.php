...
$APPLICATION->SetPageProperty("keywords", "Расчеты в китайских юанях в АКБ «ТрансСтройБанк»");
$APPLICATION->SetPageProperty("title", "Расчеты в китайских юанях | АКБ «ТрансСтройБанк»");
$APPLICATION->SetTitle("Расчеты в китайских юанях");
Asset::getInstance()->addCss("/assets/css/style-broker-deposit.css?v=1.0.6");
Asset::getInstance()->addCss("/corporative-clients/bankovskoe-obsluzhivanie/accounts-in-yuans/style.css");
?>
<??>
    <style>
        .v21 {
