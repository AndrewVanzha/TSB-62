...
$APPLICATION->SetPageProperty("description", "АКБ «Трансстройбанк» (АО) предлагает .");
$APPLICATION->SetPageProperty("keywords", "страхование, страховка, полис | АКБ «ТрансСтройБанк»");
$APPLICATION->SetPageProperty("title", "Страхование | ЧАСТНЫМ ЛИЦАМ | Трансстройбанк");
$APPLICATION->SetTitle("Страхование");
Asset::getInstance()->addCss("/chastnym-klientam/insurance/style.css");
?>
<h1 class="v21-h1-new v21-insurance--header">Страхование</h1>
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"SEF_FOLDER" => "/chastnym-klientam/insurance/",
		"SEF_MODE" => "Y",
		"SET_LAST_MODIFIED" => "N",
		"SET_STATUS_404" => "N",
		"SET_TITLE" => "Y",
...
<div class="v21-insurance-application" id="fInsuranceForm">
    <?$APPLICATION->IncludeComponent(
        "webtu:feedback",
        //"card",
        "insurance",
