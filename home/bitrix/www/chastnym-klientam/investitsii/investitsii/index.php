...
$APPLICATION->SetPageProperty("description", "Котировки мерных слитков драгоценных металлов в АКБ «Трансстройбанк»");
$APPLICATION->SetPageProperty("keywords", "Котировки, Золотые, слитки, драгоценных, металлов, ЗОЛОТО.");
$APPLICATION->SetPageProperty("title", "Вклад Инвестиционный | ЧАСТНЫМ ЛИЦАМ | Трансстройбанк");
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		//"SEF_FOLDER" => "/chastnym-klientam/vklady-i-investitsii/investitsii/",
		"SEF_FOLDER" => "/chastnym-klientam/investitsii/investitsii/",
		"SEF_MODE" => "Y",
		"SET_LAST_MODIFIED" => "N",
		"SET_STATUS_404" => "Y",
		"SET_TITLE" => "Y",
		...
		"USE_SEARCH" => "N",
		"USE_SHARE" => "N",
		"COMPONENT_TEMPLATE" => "investitsii",
