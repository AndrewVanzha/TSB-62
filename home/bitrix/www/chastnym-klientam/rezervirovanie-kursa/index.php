...
Asset::getInstance()->addCss("/chastnym-klientam/rezervirovanie-kursa/style.css");
...
{
    $file = $_SERVER['DOCUMENT_ROOT'] . '/currency/currency.json';
            ...
            <section class="reservation-rate">
                ...
                <div class="reservation-rate__city">
                    <p style="font-size: 19px;">
                        Уважаемые клиенты! Работа сервиса "Резервирование курса наличной валюты" временно приостановлена. Приносим извинения за доставленные неудобства.
                    </p>
                </div>
            </section>
        </div>
...
<? if (!empty($_SESSION['city']) && $_SESSION['city'] != 399): ?>
    <div class="page-lf">
        <div class="container">
            <section class="reservation-rate">
                <div class="reservation-rate__header">
